...
Shader "JetEngineMat"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 Offset99 = ( ( frac( ( ( ase_vertex3Pos + float3( ( _Time.y * float2( 0,-2 ) ) ,  0.0 ) ) * 4.0 ) ) * _Float2 ) * ase_vertexNormal * _Float0 );
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 Noise2 = tex2D( _TextureSample0, ( ( ase_vertex3Pos.z * ( 1.0 - ( float2( 1.46,-0.28 ) * _NoiseTiling ) ) ) + ( _Time.y * ( float2( 0.19,-1.06 ) * ( Thrust16 * _NoiseSpeed ) ) ) ) );
			...
			float4 Gradient31 = SampleGradient( gradient28, pow( ( ( ase_vertex3Pos.z * 1000.0 ) + _Float4 ) , _Float3 ) );
...
/*ASEBEGIN
Version=18900
0;622;1466;364;4182.146;533.3708;3.361828;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;27;-2183.513,616.2102;Inherit;False;1185.638;375.5255;Gradient;9;31;30;28;88;89;90;86;91;85;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;8;-2394.448,-126.7294;Inherit;False;Property;_NoiseTiling;Noise Tiling;1;0;Create;True;0;0;0;False;0;False;0.7;3.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;12;-1935.272,-3.236803;Inherit;False;Constant;_Vector22;Vector 2-2;3;0;Create;True;0;0;0;False;0;False;0.19,-1.06;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;91;-2007.54,909.5536;Inherit;False;Property;_Float4;Float 4;9;0;Create;True;0;0;0;False;0;False;0;9.67;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;89;-1840.523,909.8294;Inherit;False;Property;_Float3;Float 3;8;0;Create;True;0;0;0;False;0;False;0;0.007058823;0;0.1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;64;-1830.853,2300.391;Inherit;False;Constant;_Float1;Float 1;5;0;Create;True;0;0;0;False;0;False;4;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;38;-2119.812,1357.14;Inherit;False;Property;_EnginePower;Engine Power;3;0;Create;True;0;0;0;False;0;False;2;0.4458824;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;55;-2109.472,1722.549;Inherit;False;Property;_Gradient;Gradient;5;0;Create;True;0;0;0;False;0;False;0.5348831;0.1108082;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;67;-1645.743,2331.251;Inherit;False;Property;_Float2;Float 2;6;0;Create;True;0;0;0;False;0;False;0.3202878;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;73;-1289.12,2356.559;Inherit;False;Property;_Float0;Float 0;7;0;Create;True;0;0;0;False;0;False;0.0002;0.0005902881;0;0.01;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;40;-1416.336,1009.95;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=BCB5653EB758B7D5ECEE86482A2130E2B1D338DE