...
Shader "Water"
{
	...
	SubShader
	{
		...
		{
			float4 color12 = IsGammaSpace() ? float4(0,0.3324013,1,0) : float4(0,0.09031931,1,0);
...
/*ASEBEGIN
Version=18900
885;621;731;357;-224.0321;-270.5691;1;True;False
...
ASEEND*/
//CHKSM=A655BE25676D22EF505F9371EC4FDDEACED4CB64